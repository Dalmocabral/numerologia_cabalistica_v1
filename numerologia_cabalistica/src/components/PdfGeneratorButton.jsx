    ...
    try {
      ...
      if (selectedSections.diaNascimento && dataNascimento) {
        ...
        if (partesData.length === 3) {
          ...
          y = printWrappedText(
            "O Dia do Nascimento registra as qualidades inatas...",
            y
          );
          y += 10;
          doc.setFont("helvetica", "bold");
      ...
      if (selectedSections.diasFavoraveis && dataNascimento) {
        ...
        if (diasFav) {
          ...
          y = printWrappedText(
            "Estes são os dias do mês que vibram em harmonia com a sua energia pessoal.",
            y
          );
          y += 5;
      ...
      if (selectedSections.harmonia && nomeCliente && dataNascimento) {
        ...
        if (harmonia) {
          ...
          addWatermarkHelper();
          y = printWrappedText("A Harmonia Conjugal revela as compatibilidades.", y);
          y += 10;
          if (harmoniaComp) {
      ...
      if (selectedSections.nomesSociais && nomesSociais && nomesSociais.length > 0) {
        ...
        y = printWrappedText("O Nome Social representa a vibração que a pessoa escolhe expressar...", y); y += 10;
      ...
      if (selectedSections.previsoes && nomeCliente && dataNascimento) {
        ...
        if (transitos && transitos.length > 0) {
          ...
          y = printSectionTitle("Arcanos de Trânsito (Previsões)"); addToIndex("Previsões");
          y = printWrappedText("Esta análise divide sua vida em ciclos fixos de 4 anos.", y); y += 10;
      ...
      if (selectedSections.assinatura && assinatura) {
        ...
        y = printWrappedText("A Assinatura do Poder é uma rubrica vibracional...", y); y += 15;
